...
const filmes = [
  ...
  },  
  {
    ...
    sinopse: "Entre AFTS 1 e N1, o ETE entrou num período que ninguém gosta de comentar. Gabriel Vitor e Matheus Tiago mostram o que realmente aconteceu nesse intervalo: sustos que ninguém explica, traumas que ninguém assume e situações cômicas que só parecem engraçadas porque a alternativa seria surtar junto. Enquanto isso, o antigo grupo se despedaçou. Depois da morte de Artur, Samuel se isolou no mundo dos jogos para lidar com a depressão pós-trauma, e Andrey acabou internado após uma sequência de surtos. Com os dois fora de cena, Gabriel e Matheus ficaram no centro da confusão — tentando entender um ambiente que parecia piorar a cada semana. Entre teorias estranhas, “jogos” que ninguém pediu e aparições de figuras improváveis como Judith Butler, John Kramer e Brenda Ricks, o cenário se transforma numa mistura de tensão e humor que desafia qualquer lógica. Será que esse dupla consegue segurar as pontas e entender a partir daí o que realmente virá no futuro?",
    image: "N1 (2025).png"
  },
  {
